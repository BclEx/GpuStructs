...
namespace Tcl.Lang
{
    ...
    /// <summary>
    /// A TclInputStream is a cross between a Java InputStream and a Reader. The class supports reading raw bytes as well as
    /// encoded characters. It manages buffering and supports line oriented reading of data. It also supports a user
