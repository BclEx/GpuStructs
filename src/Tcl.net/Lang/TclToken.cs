...
/*
	For each word of a command, and for each piece of a word such as a variable reference, a TclToken is used to describe the word.

	Note: TclToken is designed to be write-once with respect to setting the script and size variables.  Failure to do this 
