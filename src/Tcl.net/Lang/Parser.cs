...
/*
	This class contains methods that parse Tcl scripts.  They do so in a general-purpose fashion that can be used for many
	different purposes, including compilation, direct execution, code analysis, etc.  This class also includes a few additional
	procedures such as evalObjv, eval, and eval2, which allow scripts to be evaluated directly, without compiling.
