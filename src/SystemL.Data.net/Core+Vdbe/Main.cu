...
namespace Core
{
...
#ifndef AMALGAMATION
	// IMPLEMENTATION-OF: R-46656-45156 The sqlite3_version[] string constant contains the text of SQLITE_VERSION macro. 
	...
	*/
	...
	{
		MUTEX_LOGIC(MutexEx *master;) // The main static mutex
			RC rc;
#ifdef OMIT_WSD
