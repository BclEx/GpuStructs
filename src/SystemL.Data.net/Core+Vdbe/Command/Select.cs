        ...
        */
        ...
        )
        {
            ...
            */
            ...
            regOutA = ++pParse.nMem;
            regOutB = ++pParse.nMem;
            DestInit(destA, SRT_Coroutine, regAddrA);
            DestInit(destB, SRT_Coroutine, regAddrB);
...
*/
        ...
        */
        static int selectExpander(Walker pWalker, Select p)
        {
            ...
            */
            if ( /* db.mallocFailed != 0 || */ ProcessJoin(pParse, p) != 0)
            {
                return WRC_Abort;
            }
